...
%Proceso de Scrum
\figura{1}{imgs/ScrumProcess.jpg}{Diagrama de la metodología Scrum [cita]}{DiagramaFuncionamientoScrum}{}
...
%Fases de Scrum
\figura{1}{imgs/ScrumDiagram.png}{Diagrama de etapas en Scrum [cita]}{DiagramaFasesScrum}{}

\subsubsection*{Roles}
\scrum{} \citeotras{scrum_wiki} define una serie de roles que se dividen en dos grupos: <<gallinas>> y <<cerdos>>.
\begin{itemize}
...
\subsection{Weka}
\weka{}[CITA] es una plataforma de software para aprendizaje automático y minería de datos, diseñada por la Universidad de Waikato. Está escrita en \java{}. Se trata de software libre distribuido bajo licencia \gnu{}.
...
\subsection{ImageJ}
ImageJ [3] es un programa de procesamiento de imagen digital de dominio público programado en \java{} desarrollado en el \emph{National Institute of Health}.
