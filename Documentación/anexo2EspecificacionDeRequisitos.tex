...
A continuación, en la tabla \vertabla{pacept} se muestran algunas de las pruebas de aceptación más relevantes realizadas sobre el programa.

\tablaSmall{Pruebas de aceptación}{ c  p{10cm}  c }{pacept}{
  \multicolumn{1}{c}{Identificación} & \multicolumn{1}{c}{Descripción} & \multicolumn{1}{c}{Resultado}\\
 }
 {
