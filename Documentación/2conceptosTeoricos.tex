...
Por lo dicho anteriormente, hemos utilizado clasificadores supervisados. Nos hemos basado en el estudio que hicieron los alumnos del año pasado con varios tipo de clasificadores, así que hemos usado el que ellos consideraron mejor: \textit{Bagging}.
...
Se ha continuado la misma idea que utilizaron los alumnos del año pasado, basada en el artículo «\underline{Automated Detection of Welding Defects without Segmentation}» de Domingo Mery [38]. Se han cambiado, entre otras cosas, el diseño arquitectónico y parte del código y de la interfaz, además de que ahora usamos un enfoque multihilo y se ha cambiado un poco parte del proceso de entrenamiento.
...
\figuraConPosicion{0.5}{imgs/precisionrecall.png}{Términos precision and recall}{pr}{}{H}
