...
javadoc -private -d docs\javadoc -encoding iso8859-1 -author ^
-classpath .\lib\ij.jar;.\lib\commons-io-2.4.jar;.\lib\weka.jar;.\lib\jh.jar;.\lib\ejml-0.21.jar;.\lib\junit-4.11.jar ^
